           ...
           <tr>
            <td>
                <div class="form-group" >
                      <label>team</label>
                      <input name="team" type="text" class="form-control" data-require="1" data-len="3-20" data-len-msg="字符串长度为5-20" data-format="[a-zA-Z0-9]+" data-format-msg="只能由英文字母和数字组成"  placeholder="redis2" >
                      <div id="team_tip"></div>
                </div>
            </td>
            <td>
